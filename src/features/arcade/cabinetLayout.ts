...
export const CABINET_PARTS: Part[] = [
  // ── Chassis ───────────────────────────────────────────────────────────────
  {
    ...
    w: 666,
    h: 450,
    r: 0, // sharp corners (real cabinet)
    z: 1,
    ...
    shadow:
      "0 56px 110px -20px rgba(0,0,0,0.62), inset 0 6px 22px rgba(200,165,255,0.06), inset 26px 0 60px rgba(0,0,0,0.26), inset -26px 0 60px rgba(0,0,0,0.26)",
  },
  {
    id: "kick",
    shape: "rect",
    ...
    shadow:
      "inset 0 3px 16px rgba(150,110,220,0.04), inset 18px 0 50px rgba(0,0,0,0.3), inset -18px 0 50px rgba(0,0,0,0.3)",
  },
  ...
  // ── Marquee ────────────────────────────────────────────────────────────────
  {
    ...
    border: "none",
    shadow:
      "0 0 50px rgba(216,114,255,0.38), 0 16px 40px -10px rgba(0,0,0,0.42), inset 0 4px 16px rgba(255,228,255,0.2), inset 0 -22px 34px rgba(18,4,38,0.68)",
  },
  ...
  // ── Hood (perspective panel under the marquee) ──────────────────────────────
  {
    ...
    shadow: "0 18px 36px -10px rgba(0,0,0,0.4)",
  },
  ...
  // ── Screen ──────────────────────────────────────────────────────────────────
  {
    ...
    shadow:
      "inset 0 4px 14px rgba(165,125,235,0.13), inset 0 0 54px rgba(0,0,0,0.88), inset 0 -18px 40px rgba(0,0,0,0.8), 0 20px 44px -12px rgba(0,0,0,0.4)",
  },
  ...
  // ── Control deck (perspective panel) ────────────────────────────────────────
  {
    ...
    shadow: "0 30px 54px -10px rgba(0,0,0,0.42)",
  },
